<%@ Page Title="Kaydol" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Kaydol.aspx.cs" Inherits="Default2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <br />
    <asp:Button ID="Button1" CssClass="button" runat="server" Text="Kaydet" ValidationGroup="a" OnClick="Button1_Click" />
